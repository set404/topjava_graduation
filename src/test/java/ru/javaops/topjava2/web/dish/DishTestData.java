...
public class DishTestData {
    ...
    public static final Dish berega_dish2 = new Dish(DISH_ID + 2, "Sushi", 500, LocalDate.now());
    public static final Dish berega_dish1 = new Dish(DISH_ID + 3, "Burger", 600, LocalDate.now());
