...
public class DateTimeUtil {
    ...
    private static LocalTime expiredVoteTime = DEFAULT_VOTE_DEADLINE_TIME;
    ...
    public static LocalTime getExpiredVoteDateTime() {
        return expiredVoteTime;
    }

    public static void setExpiredVoteTime(LocalTime expiredVoteTime) {
        DateTimeUtil.expiredVoteTime = expiredVoteTime;
    }
}
